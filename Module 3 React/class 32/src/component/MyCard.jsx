        ...
        <div className='flex justify-between'>
           {
            ...
            :   <>
            <Button onClick={showDetails} className='bg-blue-400 w-full text-white ' label="View Details" icon="pi pi-check" />
            <Button
                
                className='bg-orange-500 w-full h-[40px] text-white '
                label="Add to cart"
                icon="pi pi-times"
                style={{ marginLeft: "0.5em" }}
            />
